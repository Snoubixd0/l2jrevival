...
import com.l2jrevival.L2jRevival;
import com.l2jrevival.events.ArenaTask;
import com.l2jrevival.events.PartyFarm;
import com.l2jrevival.events.manager.CTFEventManager;
import com.l2jrevival.events.manager.TvTEventManager;
import com.l2jrevival.events.pvpevent.PvPEventManager;
import com.l2jrevival.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l2jrevival.gameserver.data.BufferTable;
import com.l2jrevival.gameserver.data.CharTemplateTable;
import com.l2jrevival.gameserver.data.DoorTable;
import com.l2jrevival.gameserver.data.IconTable;
...
import com.l2jrevival.gameserver.data.cache.CrestCache;
import com.l2jrevival.gameserver.data.cache.HtmCache;
import com.l2jrevival.gameserver.data.manager.BuyListManager;
import com.l2jrevival.gameserver.data.sql.BookmarkTable;
import com.l2jrevival.gameserver.data.sql.ClanTable;
import com.l2jrevival.gameserver.data.sql.ServerMemoTable;
import com.l2jrevival.gameserver.data.xml.AdminData;
import com.l2jrevival.gameserver.data.xml.AnnouncementData;
import com.l2jrevival.gameserver.data.xml.ArmorSetData;
...
import com.l2jrevival.gameserver.data.xml.HerbDropData;
import com.l2jrevival.gameserver.data.xml.InterfaceTeleportData;
import com.l2jrevival.gameserver.data.xml.MultisellData;
import com.l2jrevival.gameserver.data.xml.NewbieBuffData;
import com.l2jrevival.gameserver.data.xml.PkColorTable;
import com.l2jrevival.gameserver.data.xml.PvpColorTable;
import com.l2jrevival.gameserver.data.xml.SoulCrystalData;
import com.l2jrevival.gameserver.data.xml.SpellbookData;
import com.l2jrevival.gameserver.data.xml.StaticObjectData;
import com.l2jrevival.gameserver.data.xml.SummonItemData;
import com.l2jrevival.gameserver.data.xml.TeleportLocationData;
import com.l2jrevival.gameserver.data.xml.WalkerRouteData;
import com.l2jrevival.gameserver.geoengine.GeoEngine;
import com.l2jrevival.gameserver.handler.AdminCommandHandler;
import com.l2jrevival.gameserver.handler.BypassManager;
import com.l2jrevival.gameserver.handler.ChatHandler;
import com.l2jrevival.gameserver.handler.ItemHandler;
import com.l2jrevival.gameserver.handler.SkillHandler;
import com.l2jrevival.gameserver.handler.UserCommandHandler;
import com.l2jrevival.gameserver.handler.VoicedCommandHandler;
import com.l2jrevival.gameserver.idfactory.IdFactory;
import com.l2jrevival.gameserver.instancemanager.AioManager;
import com.l2jrevival.gameserver.instancemanager.AuctionManager;
import com.l2jrevival.gameserver.instancemanager.AutoSpawnManager;
import com.l2jrevival.gameserver.instancemanager.BoatManager;
...
import com.l2jrevival.gameserver.instancemanager.CharacterKillingManager;
...
import com.l2jrevival.gameserver.instancemanager.CheckManager;
...
import com.l2jrevival.gameserver.instancemanager.DayNightSpawnManager;
...
import com.l2jrevival.gameserver.instancemanager.FourSepulchersManager;
import com.l2jrevival.gameserver.instancemanager.GrandBossManager;
import com.l2jrevival.gameserver.instancemanager.HeroManager;
import com.l2jrevival.gameserver.instancemanager.IPManager;
import com.l2jrevival.gameserver.instancemanager.MovieMakerManager;
import com.l2jrevival.gameserver.instancemanager.OlyClassDamageManager;
import com.l2jrevival.gameserver.instancemanager.PartyZoneManager;
import com.l2jrevival.gameserver.instancemanager.PetitionManager;
import com.l2jrevival.gameserver.instancemanager.RaidBossInfoManager;
import com.l2jrevival.gameserver.instancemanager.RaidBossPointsManager;
import com.l2jrevival.gameserver.instancemanager.RaidBossSpawnManager;
import com.l2jrevival.gameserver.instancemanager.RaidZoneManager;
...
import com.l2jrevival.gameserver.instancemanager.SoloZoneManager;
...
import com.l2jrevival.gameserver.instancemanager.games.MonsterRace;
import com.l2jrevival.gameserver.model.World;
import com.l2jrevival.gameserver.model.actor.StatusRealTime;
...
import com.l2jrevival.gameserver.model.vehicles.BoatGiranTalking;
import com.l2jrevival.gameserver.model.vehicles.BoatGludinRune;
import com.l2jrevival.gameserver.model.vehicles.BoatInnadrilTour;
import com.l2jrevival.gameserver.model.vehicles.BoatRunePrimeval;
import com.l2jrevival.gameserver.model.vehicles.BoatTalkingGludin;
import com.l2jrevival.gameserver.network.L2GameClient;
import com.l2jrevival.gameserver.network.L2GamePacketHandler;
...
import com.l2jrevival.gameserver.taskmanager.MovementTaskManager;
import com.l2jrevival.gameserver.taskmanager.PvpFlagTaskManager;
import com.l2jrevival.gameserver.taskmanager.RandomAnimationTaskManager;
...
import com.l2jrevival.gameserver.xmlfactory.XMLDocumentFactory;
import com.l2jrevival.util.DeadLockDetector;
import com.l2jrevival.util.IPv4Filter;
...
import com.l2jrevival.commons.lang.StringUtil;
import com.l2jrevival.commons.logging.CLogger;
import com.l2jrevival.commons.mmocore.SelectorConfig;
import com.l2jrevival.commons.mmocore.SelectorThread;
import com.l2jrevival.commons.util.SysUtil;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		StringUtil.printSection("Project 2024");
		L2jRevival.info();
		...
		InterfaceTeleportData.getInstance();
	    ...
	    if (Config.ALLOW_PHANTOM_PLAYERS) {
	    	...
	    	LOGGER.info("Town Phantom: deactivated...");
	      }
	    
	    if (Config.ALLOW_PHANTOM_PLAYERS_FARM) {
	        Phantom_Farm.init();
	      } else {
	    	LOGGER.info("Phantom Farm: deactivated...");
	      }
		...
		LOGGER.info("Loaded {} bypass handlers.", BypassManager.getInstance().size());
