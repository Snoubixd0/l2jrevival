...
import com.l2jrevival.gameserver.skills.DocumentItem;
...
public class ItemTable
{
	...
	public static final Map<Integer, Weapon> _weapons = new HashMap<>();
	...
	protected ItemTable()
	{
	  ...
	  private void load()
	  {
	    ...
	    for (File file : files)
	    {
	      ...
	      for (Item item : document.getItemList())
	      {
	        ...
	        if ((item instanceof EtcItem)) {
	          ...
	          getWeapons().put(Integer.valueOf(item.getItemId()), (Weapon)item);
	        }
	      }
	    }
	    ...
	    for (Weapon item : getWeapons().values()) {
	      this._allTemplates[item.getItemId()] = item;
	    }
