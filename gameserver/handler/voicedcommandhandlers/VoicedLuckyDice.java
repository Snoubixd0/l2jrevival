...
import com.l2jrevival.gameserver.network.serverpackets.Dice;
...
public class VoicedLuckyDice implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String target)
	{
		...
		else if (command.startsWith("play1"))
      {
        ...
        try
        {
          ...
          if(type.startsWith("EventMedal"))
          {
        	  _itemId = 9501;
          }
          else if(type.startsWith("RoyalAdena"))
          {
        	  _itemId = 9508;
          }
          else if(type.startsWith("RevivalTicket"))
          {
        	  _itemId = 9503;
          }
    ...
    private static String casinoWindow(Player player)
    {
        ...
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: Event Medal: "+jackpot+"</font></td></tr>");	
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: Royal Adena: "+jackpot2+"</font></td></tr><br>"); 
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: Revival Ticket: "+jackpot3+"</font></td></tr>"); 
        tb.append("<tr></tr>");
        tb.append("</table>");
        tb.append("<table width=300>");
        tb.append("<tr>");
        ...
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: Event Medal: "+jackpot+"</font></td></tr>");	
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: Royal Adena: "+jackpot2+"</font></td></tr>"); 
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: Revival Ticket: "+jackpot3+"</font></td></tr>"); 
        tb.append("<tr></tr>");
        tb.append("</table>");
        ...
        tb.append("<td><combobox width=120 height=21 var=\"cb\"list=EventMedal;RoyalAdena;RevivalTicket></td>");
        tb.append("</tr>");
        tb.append("<tr></tr>");
        tb.append("<tr></tr>");
        tb.append("<tr>");
    ...
    public void Dice(Player activeChar,int _ammount)
    {
		if(activeChar.getInventory().getInventoryItemCount(_itemId, 0) >= _ammount)
		{
				...
				if(number == 6 && number2 == 6 || number == 6 && number2 == 5 || number == 5 && number2 == 5 || number == 3 && number2 == 3)
				{
					...
					{
					    case 9501:
						itemname = "Event Medal";
						break;
					    case 9508:
						itemname = "Royal Adena";
						break;
					    case 9503:
						itemname = "Revival Ticket";
						break;
					}
