...
public class VoicedDonate implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player activeChar, String target)
	{
		...
		else if (command.startsWith("setnoble_"))
		{
			...
			{
				activeChar.sendMessage("SYS: You already have Noble status.");
				return false;
			}
			
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.DONATE_NOBLE_PRICE, null, true))
				{
		...
		{
			if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.DONATE_SEX_PRICE, null, true))
			{
				Sex male = Sex.MALE;
				Sex female = Sex.FEMALE;
		...
		else if (command.startsWith("name_"))
		{
			...
			{
				activeChar.sendMessage("ERROR , CONTACT THE ADMINISTRATOR");
			}
		}
		else if (command.startsWith("setname_"))
		{
			...
			if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.DONATE_NAME_PRICE, null, true))
			{
		...
		else if (command.startsWith("setclass_"))
		{
			...
			else if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.DONATE_CLASS_PRICE, null, true))
			{
				...
				if (activeChar._class_id == 1)
				{
					...
					{
						activeChar.sendMessage("Sorry, you are already with the Class " + nameclasse + ".");
						return false;
					}
		...
		else if (command.startsWith("setvip_"))
		{
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.VIP_30_DAYS_PRICE, null, true))
				{
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.VIP_60_DAYS_PRICE, null, true))
				{
					if (VipManager.getInstance().hasVipPrivileges(activeChar.getObjectId()))
					{
						long _daysleft;
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.VIP_90_DAYS_PRICE, null, true))
				{
					if (VipManager.getInstance().hasVipPrivileges(activeChar.getObjectId()))
					{
						long _daysleft;
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.VIP_ETERNAL_PRICE, null, true))
				{
		...
		else if (command.startsWith("sethero_"))
		{
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.HERO_30_DAYS_PRICE, null, true))
				{
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.HERO_60_DAYS_PRICE, null, true))
				{
					if (HeroManager.getInstance().hasHeroPrivileges(activeChar.getObjectId()))
					{
						long _daysleft;
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.HERO_90_DAYS_PRICE, null, true))
				{
					if (HeroManager.getInstance().hasHeroPrivileges(activeChar.getObjectId()))
					{
						long _daysleft;
			...
			{
				if (activeChar.destroyItemByItemId("Donate Ticket", Config.DONATE_COIN_ID, Config.HERO_ETERNAL_PRICE, null, true))
				{
	...
	public static void addargument(Player activeChar, int id, int lvl)
	{
	    ...
	    if (rhand == null)
	    {
	      activeChar.sendMessage("SYS: You are not equipped with the weapon.");
	      return;
	    }
		
		if (rhand.isAugmented())
		{
			activeChar.sendMessage("SYS: This weapon is already Argumented.");
			return;
		}
	    ...
	    if (rhand != null)
	    {
	      ...
	      activeChar.sendPacket(iu);
				 ...
				 activeChar.sendMessage("You don't have enough donate tickets.");
			}
	    }
