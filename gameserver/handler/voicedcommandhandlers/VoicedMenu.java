...
import com.l2jrevival.events.manager.PvPEventNext;
import com.l2jrevival.events.manager.TvTEventManager;
import com.l2jrevival.events.pvpevent.PvPEvent;
import com.l2jrevival.bossInstancedEvent.NextBossEvent;
import com.l2jrevival.bossInstancedEvent.BossEvent;
import com.l2jrevival.gameserver.ArenaEvent;
import com.l2jrevival.gameserver.MissionReset;
import com.l2jrevival.gameserver.NewZoneVote;
import com.l2jrevival.gameserver.PartyFarmEvent;
import com.l2jrevival.gameserver.Restart;
...
import com.l2jrevival.gameserver.taskmanager.AutoGoldBar;
...
public class VoicedMenu implements IVoicedCommandHandler
{
	...
	{		
		...
		if(Config.BOSS_EVENT_TIME_ON_SCREEN){
			if(BossEvent.is_started())	
			html.replace("%boss%", "In Progress");
			else	
			html.replace("%boss%", NextBossEvent.getInstance().getNextTime().toString() );
		}
