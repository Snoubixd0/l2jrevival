	...
	public boolean useVoicedCommand(String command, Player activeChar, String target)
	{
		...
		else if (command.equalsIgnoreCase("deposit"))
		{
			if (activeChar.getInventory().getInventoryItemCount(57, 0) >= Config.BANKING_SYSTEM_ADENA)
			{
				...
				activeChar.sendMessage("Now you have " + Config.BANKING_SYSTEM_GOLDBARS + " Royal Adena(s), and " + Config.BANKING_SYSTEM_ADENA + " less adena.");
			}
			else
			{
				activeChar.sendMessage("You do not have enough Adena to convert to Royal Adena(s), you need " + Config.BANKING_SYSTEM_ADENA + " Adena.");
			}
		}
		else if (command.equalsIgnoreCase("withdraw"))
		{
			...
			{
				activeChar.sendMessage("You do not have any Royal Adena to turn into " + Config.BANKING_SYSTEM_ADENA + " Adena.");
			}
		}
		return true;
	}
