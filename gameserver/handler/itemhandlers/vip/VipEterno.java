 ...
 */
package com.l2jrevival.gameserver.handler.itemhandlers.vip;
...
public class VipEterno implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		for (Player allgms : World.getAllGMs())
			allgms.sendPacket(new CreatureSay(0, Say2.SHOUT, "(Vip Manager)", activeChar.getName() + " Active Vip Eternal."));
