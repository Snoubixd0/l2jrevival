package com.l2jrevival.gameserver.model.actor.ai.type;
...
import com.l2jrevival.commons.util.ArraysUtil;
...
import com.l2jrevival.gameserver.model.actor.instance.FestivalMonster;
import com.l2jrevival.gameserver.model.actor.instance.FriendlyMonster;
import com.l2jrevival.gameserver.model.actor.instance.GrandBoss;
import com.l2jrevival.gameserver.model.actor.instance.Guard;
...
public class AttackableAI extends CreatureAI implements Runnable
{
	...
	protected boolean autoAttackCondition(Creature target)
	{
		...
		// do not attack agathion
		if (target instanceof L2AgathionInstance)
		{
			return false;
		}
