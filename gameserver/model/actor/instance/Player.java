...
import com.l2jrevival.gameserver.LoginServerThread;
import com.l2jrevival.gameserver.communitybbs.BB.Forum;
import com.l2jrevival.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l2jrevival.gameserver.data.CharTemplateTable;
import com.l2jrevival.gameserver.data.ItemTable;
import com.l2jrevival.gameserver.data.MapRegionTable.TeleportType;
import com.l2jrevival.gameserver.data.NpcTable;
import com.l2jrevival.gameserver.data.PlayerNameTable;
import com.l2jrevival.gameserver.data.RecipeTable;
import com.l2jrevival.gameserver.data.SkillTable;
import com.l2jrevival.gameserver.data.SkillTable.FrequentSkill;
import com.l2jrevival.gameserver.data.SkillTreeTable;
import com.l2jrevival.gameserver.data.sql.ClanTable;
import com.l2jrevival.gameserver.data.xml.AdminData;
import com.l2jrevival.gameserver.data.xml.FishData;
import com.l2jrevival.gameserver.data.xml.HennaData;
import com.l2jrevival.gameserver.data.xml.PkColorTable;
import com.l2jrevival.gameserver.data.xml.PkColorTable.PkColor;
import com.l2jrevival.gameserver.data.xml.PvpColorTable;
import com.l2jrevival.gameserver.data.xml.PvpColorTable.PvpColor;
import com.l2jrevival.gameserver.geoengine.GeoEngine;
import com.l2jrevival.gameserver.handler.IItemHandler;
import com.l2jrevival.gameserver.handler.ItemHandler;
import com.l2jrevival.gameserver.handler.admincommandhandlers.AdminEditChar;
...
import com.l2jrevival.gameserver.instancemanager.ChatBanManager;
import com.l2jrevival.gameserver.instancemanager.ChatGlobalManager;
import com.l2jrevival.gameserver.instancemanager.ChatHeroManager;
import com.l2jrevival.gameserver.instancemanager.CoupleManager;
import com.l2jrevival.gameserver.instancemanager.CursedWeaponsManager;
import com.l2jrevival.gameserver.instancemanager.DimensionalRiftManager;
import com.l2jrevival.gameserver.instancemanager.DuelManager;
import com.l2jrevival.gameserver.instancemanager.HeroManager;
import com.l2jrevival.gameserver.instancemanager.SevenSigns;
import com.l2jrevival.gameserver.instancemanager.SevenSigns.CabalType;
import com.l2jrevival.gameserver.instancemanager.SevenSigns.SealType;
import com.l2jrevival.gameserver.instancemanager.SevenSignsFestival;
import com.l2jrevival.gameserver.instancemanager.VipManager;
import com.l2jrevival.gameserver.instancemanager.VoteZone;
import com.l2jrevival.gameserver.instancemanager.ZoneManager;
import com.l2jrevival.gameserver.model.AccessLevel;
import com.l2jrevival.gameserver.model.Announcement;
import com.l2jrevival.gameserver.model.BlockList;
import com.l2jrevival.gameserver.model.DressMe;
import com.l2jrevival.gameserver.model.Fish;
import com.l2jrevival.gameserver.model.L2Effect;
import com.l2jrevival.gameserver.model.L2Fishing;
import com.l2jrevival.gameserver.model.L2Macro;
import com.l2jrevival.gameserver.model.L2ManufactureList;
import com.l2jrevival.gameserver.model.L2Party;
import com.l2jrevival.gameserver.model.L2Party.MessageType;
import com.l2jrevival.gameserver.model.L2Radar;
import com.l2jrevival.gameserver.model.L2Request;
import com.l2jrevival.gameserver.model.L2ShortCut;
import com.l2jrevival.gameserver.model.L2Skill;
import com.l2jrevival.gameserver.model.L2Skill.SkillTargetType;
import com.l2jrevival.gameserver.model.L2SkillLearn;
import com.l2jrevival.gameserver.model.MacroList;
import com.l2jrevival.gameserver.model.PetDataEntry;
import com.l2jrevival.gameserver.model.ShortCuts;
...
import com.l2jrevival.gameserver.model.WorldRegion;
...
import com.l2jrevival.gameserver.model.actor.Vehicle;
import com.l2jrevival.gameserver.model.actor.ai.CtrlEvent;
import com.l2jrevival.gameserver.model.actor.ai.CtrlIntention;
import com.l2jrevival.gameserver.model.actor.ai.NextAction;
import com.l2jrevival.gameserver.model.actor.ai.type.CreatureAI;
import com.l2jrevival.gameserver.model.actor.ai.type.PlayerAI;
import com.l2jrevival.gameserver.model.actor.ai.type.SummonAI;
import com.l2jrevival.gameserver.model.actor.appearance.PcAppearance;
import com.l2jrevival.gameserver.model.actor.stat.PlayerStat;
import com.l2jrevival.gameserver.model.actor.status.PlayerStatus;
import com.l2jrevival.gameserver.model.actor.template.PetTemplate;
import com.l2jrevival.gameserver.model.actor.template.PlayerTemplate;
import com.l2jrevival.gameserver.model.base.ClassId;
import com.l2jrevival.gameserver.model.base.ClassRace;
import com.l2jrevival.gameserver.model.base.ClassType;
import com.l2jrevival.gameserver.model.base.Experience;
import com.l2jrevival.gameserver.model.base.Sex;
import com.l2jrevival.gameserver.model.base.SubClass;
import com.l2jrevival.gameserver.model.entity.Castle;
import com.l2jrevival.gameserver.model.entity.Duel.DuelState;
import com.l2jrevival.gameserver.model.entity.Hero;
...
import com.l2jrevival.gameserver.model.holder.SkillUseHolder;
import com.l2jrevival.gameserver.model.item.Henna;
import com.l2jrevival.gameserver.model.item.RecipeList;
import com.l2jrevival.gameserver.model.item.instance.ItemInstance;
import com.l2jrevival.gameserver.model.item.instance.ItemInstance.ItemLocation;
import com.l2jrevival.gameserver.model.item.instance.ItemInstance.ItemState;
import com.l2jrevival.gameserver.model.item.kind.Armor;
import com.l2jrevival.gameserver.model.item.kind.Item;
import com.l2jrevival.gameserver.model.item.kind.Weapon;
import com.l2jrevival.gameserver.model.item.type.ActionType;
import com.l2jrevival.gameserver.model.item.type.ArmorType;
import com.l2jrevival.gameserver.model.item.type.EtcItemType;
...
import com.l2jrevival.gameserver.model.itemcontainer.ItemContainer;
import com.l2jrevival.gameserver.model.itemcontainer.PcFreight;
import com.l2jrevival.gameserver.model.itemcontainer.PcInventory;
import com.l2jrevival.gameserver.model.itemcontainer.PcWarehouse;
import com.l2jrevival.gameserver.model.itemcontainer.PetInventory;
import com.l2jrevival.gameserver.model.itemcontainer.listeners.ItemPassiveSkillsListener;
...
import com.l2jrevival.gameserver.model.multisell.PreparedListContainer;
import com.l2jrevival.gameserver.model.olympiad.OlympiadGameManager;
import com.l2jrevival.gameserver.model.olympiad.OlympiadGameTask;
import com.l2jrevival.gameserver.model.olympiad.OlympiadManager;
...
import com.l2jrevival.gameserver.model.pledge.ClanMember;
import com.l2jrevival.gameserver.model.tradelist.TradeList;
import com.l2jrevival.gameserver.model.zone.ZoneId;
import com.l2jrevival.gameserver.model.zone.type.L2BossZone;
...
import com.l2jrevival.gameserver.network.serverpackets.AbstractNpcInfo;
import com.l2jrevival.gameserver.network.serverpackets.ActionFailed;
import com.l2jrevival.gameserver.network.serverpackets.ChairSit;
import com.l2jrevival.gameserver.network.serverpackets.ChangeWaitType;
import com.l2jrevival.gameserver.network.serverpackets.CharInfo;
import com.l2jrevival.gameserver.network.serverpackets.ConfirmDlg;
import com.l2jrevival.gameserver.network.serverpackets.CreatureSay;
import com.l2jrevival.gameserver.network.serverpackets.DeleteObject;
import com.l2jrevival.gameserver.network.serverpackets.EtcStatusUpdate;
import com.l2jrevival.gameserver.network.serverpackets.ExAutoSoulShot;
import com.l2jrevival.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l2jrevival.gameserver.network.serverpackets.ExFishingEnd;
import com.l2jrevival.gameserver.network.serverpackets.ExFishingStart;
import com.l2jrevival.gameserver.network.serverpackets.ExOlympiadMode;
import com.l2jrevival.gameserver.network.serverpackets.ExPCCafePointInfo;
import com.l2jrevival.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.l2jrevival.gameserver.network.serverpackets.ExShowScreenMessage;
import com.l2jrevival.gameserver.network.serverpackets.ExStorageMaxCount;
import com.l2jrevival.gameserver.network.serverpackets.FriendList;
import com.l2jrevival.gameserver.network.serverpackets.GetOnVehicle;
import com.l2jrevival.gameserver.network.serverpackets.HennaEquipList;
import com.l2jrevival.gameserver.network.serverpackets.HennaInfo;
...
import com.l2jrevival.gameserver.network.serverpackets.L2GameServerPacket;
import com.l2jrevival.gameserver.network.serverpackets.LeaveWorld;
...
import com.l2jrevival.gameserver.network.serverpackets.ObservationMode;
import com.l2jrevival.gameserver.network.serverpackets.ObservationReturn;
import com.l2jrevival.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.l2jrevival.gameserver.network.serverpackets.PetInventoryUpdate;
import com.l2jrevival.gameserver.network.serverpackets.PlaySound;
import com.l2jrevival.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l2jrevival.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreManageListSell;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import com.l2jrevival.gameserver.network.serverpackets.PrivateStoreMsgSell;
import com.l2jrevival.gameserver.network.serverpackets.RecipeShopManageList;
import com.l2jrevival.gameserver.network.serverpackets.RecipeShopMsg;
import com.l2jrevival.gameserver.network.serverpackets.RecipeShopSellList;
import com.l2jrevival.gameserver.network.serverpackets.RelationChanged;
import com.l2jrevival.gameserver.network.serverpackets.Ride;
import com.l2jrevival.gameserver.network.serverpackets.SendTradeDone;
import com.l2jrevival.gameserver.network.serverpackets.ServerClose;
import com.l2jrevival.gameserver.network.serverpackets.SetupGauge;
import com.l2jrevival.gameserver.network.serverpackets.SetupGauge.GaugeColor;
import com.l2jrevival.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.l2jrevival.gameserver.network.serverpackets.ShortCutInit;
import com.l2jrevival.gameserver.network.serverpackets.SkillCoolTime;
import com.l2jrevival.gameserver.network.serverpackets.SkillList;
import com.l2jrevival.gameserver.network.serverpackets.SocialAction;
import com.l2jrevival.gameserver.network.serverpackets.SpawnItem;
import com.l2jrevival.gameserver.network.serverpackets.StaticObjectInfo;
import com.l2jrevival.gameserver.network.serverpackets.StatusUpdate;
import com.l2jrevival.gameserver.network.serverpackets.StopMove;
import com.l2jrevival.gameserver.network.serverpackets.SystemMessage;
import com.l2jrevival.gameserver.network.serverpackets.TargetSelected;
import com.l2jrevival.gameserver.network.serverpackets.TargetUnselected;
import com.l2jrevival.gameserver.network.serverpackets.TitleUpdate;
import com.l2jrevival.gameserver.network.serverpackets.TradePressOtherOk;
import com.l2jrevival.gameserver.network.serverpackets.TradePressOwnOk;
import com.l2jrevival.gameserver.network.serverpackets.TradeStart;
...
import com.l2jrevival.gameserver.scripting.EventType;
...
import com.l2jrevival.gameserver.skills.effects.EffectTemplate;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaCON;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaDEX;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaINT;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaMEN;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaSTR;
import com.l2jrevival.gameserver.skills.funcs.FuncHennaWIT;
import com.l2jrevival.gameserver.skills.funcs.FuncMaxCpMul;
import com.l2jrevival.gameserver.skills.l2skills.L2SkillSiegeFlag;
import com.l2jrevival.gameserver.skills.l2skills.L2SkillSummon;
import com.l2jrevival.gameserver.taskmanager.AttackStanceTaskManager;
import com.l2jrevival.gameserver.taskmanager.GameTimeTaskManager;
import com.l2jrevival.gameserver.taskmanager.ItemsOnGroundTaskManager;
import com.l2jrevival.gameserver.taskmanager.PvpFlagTaskManager;
import com.l2jrevival.gameserver.taskmanager.ShadowItemTaskManager;
import com.l2jrevival.gameserver.taskmanager.WaterTaskManager;
import com.l2jrevival.gameserver.templates.skills.L2EffectFlag;
...
import com.l2jrevival.util.CloseUtil;
import com.l2jrevival.Dungeon.Dungeon;
import com.l2jrevival.Dungeon.Instance;
import com.l2jrevival.Manager.NewCharTaskManager;
import com.l2jrevival.util.Mysql;
...
import com.l2jrevival.gameserver.model.actor.instance.L2AgathionInstance;

import com.l2jrevival.gameserver.VoteSystem.VoteDao;
import com.l2jrevival.gameserver.VoteSystem.VoteSite;
import com.l2jrevival.commons.util.StringUtil;
...
public class Player extends Playable
{
	...
	private static final String UPDATE_CHARACTER = "UPDATE characters SET level=?,maxHp=?,curHp=?,maxCp=?,curCp=?,maxMp=?,curMp=?,face=?,hairStyle=?,hairColor=?,sex=?,heading=?,x=?,y=?,z=?,exp=?,expBeforeDeath=?,sp=?,karma=?,pvpkills=?,pkkills=?,rec_have=?,rec_left=?,clanid=?,race=?,classid=?,deletetime=?,title=?,accesslevel=?,online=?,isin7sdungeon=?,clan_privs=?,wantspeace=?,base_class=?,onlinetime=?,punish_level=?,punish_timer=?,nobless=?,power_grade=?,subpledge=?,last_recom_date=?,lvl_joined_academy=?,apprentice=?,sponsor=?,varka_ketra_ally=?,clan_join_expiry_time=?,clan_create_expiry_time=?,char_name=?,death_penalty_level=?,preview=?,equip=?,wepequip=?,pc_point=?,autofarm_time=? WHERE obj_id=?";
	...
	/**
	 * @see com.l2jrevival.gameserver.model.actor.Creature#enableSkill(com.l2jrevival.gameserver.model.L2Skill)
	 */
	@Override
	...
	public boolean checkDoCastConditions(L2Skill skill)
	{
		...
		{
			if(((L2SkillSummon) skill).isAgathion())
			{
				if (getAgathion()!=null)
				{
					sendMessage("You have already summoned agathion.");
					return false;
				}
			}
	...
	/**
	 * @return Return the L2AgathionInstance of the L2PcInstance or null
	 */
	...
	/**
	 * Set the L2AgahtionInstance of the L2PcInstance.
	 * @param agahtion The Object.
	 */
	public void setAgathion(L2AgathionInstance agahtion)
	{
		_agathion = agahtion;
	}
	...
	public boolean mount(Summon pet)
	{
		...
		// when mounting wyvern agathion will be unsummoned
		if (pet.getNpcId()==12621)
		{
			_agathion.unSummon(this);
		}
	...
	public static Player restore(int objectId)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			while (rset.next())
			{
				...
				player.setAutofarmTimeLeft(rset.getLong("autofarm_time"));
	...
	private void storeCharBase()
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			statement.setLong(54, getAutofarmTimeLeft());
	...
	// teleport agathion with you
	L2AgathionInstance agathion = getAgathion();
	if (agathion != null)
	{
		agathion.setFollowStatus(false);
		agathion.teleToLocation(getPosition().getX(), getPosition().getY(), getPosition().getZ(), 0);
		//((L2SummonAI) pet.getAI()).setStartFollowController(true);
		agathion.setFollowStatus(true);
	}
}
	...
	protected synchronized void cleanup()
	{
		try
		{
			...
			// If the Player has Aganthion, unsummon it
			if (getAgathion() != null)
				getAgathion().unSummon(this);			
	...
	private volatile long autofarmTimeLeft;
	
	public final long getAutofarmTimeLeft()
	{
		return autofarmTimeLeft;
	}
	
	public final void setAutofarmTimeLeft(long autofarmTimeLeft)
	{
		this.autofarmTimeLeft = Math.max(0L, autofarmTimeLeft);
	}
