...
public final class L2Spawn implements Runnable
{
	...
	public L2Spawn(NpcTemplate template) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		{
			int.class,
			Class.forName("com.l2jrevival.gameserver.model.actor.template.NpcTemplate")
		};
		_constructor = Class.forName("com.l2jrevival.gameserver.model.actor.instance." + _template.getType()).getConstructor(parameters);
	}
