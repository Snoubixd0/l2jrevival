package com.l2jrevival.gameserver.instancemanager.games;
...
import com.l2jrevival.gameserver.model.zone.type.L2DerbyTrackZone;
...
import com.l2jrevival.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_constructor = Class.forName("com.l2jrevival.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];
