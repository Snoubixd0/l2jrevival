package com.l2jrevival.gameserver.scripting.scripts.ai;
...
public class L2AttackableAIScript extends Quest
{
	...
	protected void registerNpcs()
	{
		...
		for (NpcTemplate template : NpcTable.getInstance().getAllNpcs())
		{
			try
			{
				if (Attackable.class.isAssignableFrom(Class.forName("com.l2jrevival.gameserver.model.actor.instance." + template.getType())))
				{
